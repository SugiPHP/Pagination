...
class Bootstrap3
{
    public static function renderPagination(array $pages)
    {
    ...
    public static function renderPager(array $pages)
    {
    ...
    public static function renderAlignedPager(array $pages)
    {
        $string = '<ul class="pager">';
